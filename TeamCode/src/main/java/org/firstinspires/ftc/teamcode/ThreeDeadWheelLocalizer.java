...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks =  -3393.3744181090506; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 3798.2130824157657; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -3414.176100799576; // x position of the perpendicular encoder (in tick units)
    }
